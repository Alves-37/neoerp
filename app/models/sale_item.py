...
class SaleItem(Base):
    ...
    price_at_sale: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    cost_at_sale: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, default=0)
